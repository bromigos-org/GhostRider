...
from .base import MessagePlatform as BasePlatform
...
class TextBeeSMSPlatform(BasePlatform):
    """TextBee SMS platform integration."""
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise ConnectionError("Failed to connect to TextBee API: Connection timeout")
        except requests.exceptions.RequestException as e:
            raise ConnectionError(f"Failed to connect to TextBee API: {e}")
