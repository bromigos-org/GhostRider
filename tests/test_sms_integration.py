...
from ghostrider.platforms.sms import TextBeeSMSPlatform, TextBeeConfig
...
@pytest.fixture
def sms_platform(textbee_config):
...
class TestTextBeeSMSPlatform:
    ...
    def test_init(self, textbee_config):
    ...
    async def test_connect_success(self, mock_get, sms_platform):
    ...
    @pytest.mark.asyncio
    @patch('requests.Session.get')
    async def test_connect_failure(self, mock_get, sms_platform):
    ...
    async def test_send_message_success(self, mock_post, sms_platform):
    ...
    @pytest.mark.asyncio
    @patch('requests.Session.post')
    async def test_send_message_failure(self, mock_post, sms_platform):
    ...
    @pytest.mark.asyncio
    @patch('requests.Session.get')
    async def test_receive_messages_success(self, mock_get, sms_platform, sample_sms_data):
    ...
    @pytest.mark.asyncio
    @patch('requests.Session.get')
    async def test_receive_messages_empty(self, mock_get, sms_platform):
    ...
    @pytest.mark.asyncio
    @patch('requests.Session.get')
    async def test_receive_messages_deduplication(self, mock_get, sms_platform, sample_sms_data):
    ...
    def test_convert_to_unified_message(self, sms_platform, sample_sms_data):
    ...
    def test_convert_timestamp_formats(self, sms_platform):
