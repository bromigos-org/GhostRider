...
def sample_message() -> UnifiedMessage:
    ...
    return UnifiedMessage(
        ...
        author=MessageAuthor(id="+1234567890", name="Test User", phone="+1234567890"),
        metadata=MessageMetadata(platform=MessagePlatform.SMS, message_id="test_1"),
        sms_metadata=SMSMetadata(device_id="test_device", phone_number="+1234567890"),
    )
...
class TestMessageProcessor:
    ...
    @pytest.mark.asyncio
    async def test_process_batch(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_classify_priority_urgent(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_classify_priority_high(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_classify_priority_low(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_classify_priority_medium_default(
        self, processor: MessageProcessor, sample_message: UnifiedMessage
    ) -> None:
    ...
    def test_sms_specific_priority_rules(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_time_based_urgency(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_extract_context_tags_platform(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
        """Test platform context tag extraction."""
        tags = processor._extract_context_tags(sample_message)

        assert "platform:sms" in tags

    def test_extract_context_tags_meeting(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_extract_context_tags_financial(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_extract_context_tags_security(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_extract_context_tags_delivery(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_extract_context_tags_url(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_extract_context_tags_phone(self, processor: MessageProcessor, sample_message: UnifiedMessage) -> None:
    ...
    def test_extract_context_tags_time_sensitive(
        self, processor: MessageProcessor, sample_message: UnifiedMessage
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_process_batch_skip_processed(
        self, processor: MessageProcessor, sample_message: UnifiedMessage
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_process_batch_error_handling(self, processor: MessageProcessor) -> None:
